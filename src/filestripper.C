...
void filestripper()
{
    ...
    toutput->Branch("Event", &, "Event/I");
    toutput->Branch("Run", &, "Run/I");
    toutput->Branch("runStatus", &, "runStatus/I");
    toutput->Branch("nElectrons", &, "nElectrons/I");
    toutput->Branch("radonWeight", &, "radonWeight/D");
    toutput->Branch("bi210Weight", &, "bi210Weight/D");
    toutput->Branch("foilSide", &, "foilSide/I");
    toutput->Branch("eventTime", &, "eventTime/D");
    toutput->Branch("trueVertexR", &, "trueVertexR/D");
    toutput->Branch("trueVertexZ", &, "trueVertexZ/D");
    toutput->Branch("trueVertexSector", &, "trueVertexSector/D");
    toutput->Branch("trueVertexLayer", &, "trueVertexLayer/I");
    toutput->Branch("electronEnergy", &, "electronEnergy[2]/D");
    toutput->Branch("eTrackLength", &, "eTrackLength[2]/D");
    toutput->Branch("electronSide", &, "electronSide[2]/I");
    toutput->Branch("trackSign", &, "trackSign[2]/D");
    toutput->Branch("electronMeasTime", &, "electronMeasTime[2]/D");
    toutput->Branch("electronDMeasTime", &, "electronDMeasTime[2]/D");
    toutput->Branch("electronBlockType", &, "electronBlockType[2]/I");
    toutput->Branch("internalPull", &, "internalPull/D");
    toutput->Branch("internalProb", &, "internalProb/D");
    toutput->Branch("externalPull", &, "externalPull/D");
    toutput->Branch("externalProb", &, "externalProb/D");
    toutput->Branch("cosee", &, "cosee/D");
    toutput->Branch("cosee_weight", &, "cosee_weight/D");
    toutput->Branch("electronPMT", &, "electronPMT[2]/I");
    toutput->Branch("electronLDFlag", &, "electronLDFlag[2]/I");
    toutput->Branch("electronLDCorr", &, "electronLDCorr[2]/D");
    toutput->Branch("electronLDCorrErr", &, "electronLDCorrErr[2]/D");
    toutput->Branch("vertexZ", &, "vertexZ[2]/D");
    toutput->Branch("vertexSec", &, "vertexSec[2]/D");
    toutput->Branch("vertexR", &, "vertexR[2]/D");
    toutput->Branch("vertexInHotSpot", &, "vertexInHotSpot[2]/O");
    toutput->Branch("firstGgHitLayer", &, "firstGgHitLayer[2]/I");
    toutput->Branch("lastGgHitLayer", &, "lastGgHitLayer[2]/I");
    toutput->Branch("NAPromptGgHits", &, "NAPromptGgHits/I");
    toutput->Branch("NAPromptGgHitsSide", &, "NAPromptGgHitsSide/I");
    toutput->Branch("NAPromptGgHitsDist2Vertex", &, "NAPromptGgHitsDist2Vertex[NAPromptGgHits]/D");
    toutput->Branch("NAPromptGgHitsDist2Calo", &, "NAPromptGgHitsDist2Calo[NAPromptGgHits]/D");
    toutput->Branch("nGammaClusters", &, "nGammaClusters/I");
    toutput->Branch("nInCluster", &, "nInCluster[nGammaClusters]/I");
    toutput->Branch("clusterEnergy", &, "clusterEnergy[nGammaClusters]/D");
    toutput->Branch("clusterTimeSpan", &, "clusterTimeSpan[nGammaClusters]/D");
    toutput->Branch("nTotalClusterHits", &, "nTotalClusterHits/I");
    toutput->Branch("clusterHitEnergy", &, "clusterHitEnergy[nTotalClusterHits]/D");
    toutput->Branch("clusterHitPMT", &, "clusterHitPMT[nTotalClusterHits]/I");
    toutput->Branch("clusterHitLDFlag", &, "clusterHitLDFlags[nTotalClusterHits]/I");
    toutput->Branch("clusterHitLDCorr", &, "clusterHitLDCorr[nTotalClusterHits]/D");
    toutput->Branch("clusterHitLDCorrErr", &, "clusterHitLDCorrErr[nTotalClusterHits]/D");
    toutput->Branch("clusterHitSec", &, "clusterHitSec[nTotalClusterHits]/D");
    toutput->Branch("clusterHitZ", &, "clusterHitZ[nTotalClusterHits]/D");
