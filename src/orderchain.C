...
void orderchain()
{
    ...
    foutput = new TFile(outputdir + TString("foils_nd150_61_rot_nd150_1xx_xx.root"), "RECREATE");
    ...
    for(Int_t run_find{run_min}; run_find > run_max; -- run_find)
    {
        std::cout << "searching for run=" << run_find << std::endl;
        Long64_t found_total = 0;
        Long64_t found_this_file;
        ...
        for(int i = 0; i < 20; ++ i)
        {
            ...
            std::cout << "Reading: " << nameout << std::endl;
            //std::cout << "Writing: " << nameout << std::endl;

            ///////////////////////////////////////////////////////////////////////

            finput = new TFile(inputdir + TString(nameout.c_str()));
            ...
            std::cout << "found " << found_this_file << " matching run numbers" << std::endl;
